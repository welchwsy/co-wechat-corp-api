 ...
 */
exports.batchInviteUser = async (to, callback) => {
 ...
 * @param {Object} callback 任务执行完毕后的回调结构
 */
exports.batchSyncUser = async (mediaId, callback) => {
  var token = await this.ensureAccessToken();
 ...
 * @param {Object} callback 任务执行完毕后的回调结构
 */
exports.batchReplaceUser = async (mediaId, callback) => {
  var token = await this.ensureAccessToken();
 ...
 * @param {Object} callback 任务执行完毕后的回调结构
 */
exports.batchReplaceParty = async (mediaId, callback) => {
  var token = await this.ensureAccessToken();
 ...
 */
exports.batchGetResult = async (jobid) => {
  var token = await this.ensureAccessToken();
